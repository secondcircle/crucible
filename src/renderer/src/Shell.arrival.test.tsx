...
describe('what an arrival closes', () => {
  ...
  // No exemption for a live login: it is drawn on the Settings card, and a
  // flow left running behind a closed card would take the next Escape press
  // for a dialog nobody can see. Closing it cancels the flow outright.
  it('takes a live login dialog off with the card that drew it', async () => {
    await shell()
    await click('Settings')
