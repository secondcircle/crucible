...
// beside it: a compaction leaves the summary behind, and one is worth its
// model call when it takes away at least as much as it leaves. A lower minimum would be a field that accepts a number it does
