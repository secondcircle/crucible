...
//
// The origin ladder against real directories, through π's own loader, because
// the loader is the decision and a substitute would prove nothing about it. No
// session is constructed, no model is called and nothing is spent.
