...
import type { EditEvent, Rule } from '../../../resources/rule-lib/rule.ts'
import { commentBlocks } from '../../../resources/rule-lib/extract.ts'
import { blame, changedFiles, git, show } from '../../../resources/rule-lib/git.ts'
