...
//
// Only repo workflows carry schedules (ADR 0023's day-one boundary): a
// `schedule` field on a user or built-in workflow is ignored — not fired, not
// listed, no error. They would otherwise fire in every workspace at once.
